...
Budget Buddy is a web application designed for managing personal and group finances. Users can track their income and expenses, set personal or group financial goals, and collaborate in groups to achieve shared objectives. This project was developed as a semester assignment for the ОРИС course. The application emphasizes user authentication, financial tracking, and collaborative goal-setting without real money transactions—contributions are tracked as virtual pledges toward goals.
